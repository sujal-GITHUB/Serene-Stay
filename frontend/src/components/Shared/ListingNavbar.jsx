...
const ListingNavbar = () => {
  ...
  return (
    <nav
      className={` top-0 z-10 bg-lightDarkBlue transition-all rounded-br-3xl rounded-bl-3xl duration-300 max-w-screen-xl px-4 sm:px-8 md:px-10 xl:px-20 xl:mx-auto ${
        isSticky ? " border-b-[1.4px] border-[#f1f1f1] sticky bottom-0" : ""
      }`}
    >
      <div className=" pt-3 pb-4 flex flex-row justify-between items-center ">
        <Link to={"/"}>
